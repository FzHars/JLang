...
export default function HiraganaAccordion({
  ...
  return (
    <div className="bg-white border-2 border-green-200 rounded-3xl overflow-hidden shadow-xl shadow-green-100">
      {/* Type Header */}
      <div className="w-full flex items-center justify-between p-6 bg-green-50">
        <div className="flex items-center gap-4">
          ...
          <div className="text-left">
            <h3 className="font-bold text-lg capitalize text-green-900">
              Hiragana
            </h3>
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    >
                      <Icon
                        className={`w-4 h-4 ${
                          isCatExpanded ? "text-green-600" : "text-green-500"
                        }`}
                      />
                    </span>
                    {/* Category name */}
                              ...
                              <div className="flex-1 text-left min-w-0">
                                ...
                                <div className="flex gap-2 mt-0.5 overflow-x-auto scrollbar-hide">
                                  {chars.slice(0, 5).map((c) => (
                                    <span
                                      key={c.id}
                                      className="text-xs font-jp opacity-50 whitespace-nowrap"
                                    >
                                      {c.char}
                                    </span>
                                  ))}
