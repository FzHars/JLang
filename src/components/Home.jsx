...
export default function Home({ onStart }) {
  const [expandedType, setExpandedType] = useState('hiragana');
  const [expandedCategories, setExpandedCategories] = useState(['base']);
        ...
        <div className="fixed bottom-0 left-0 right-0 p-4 md:p-6 bg-white/90 backdrop-blur-xl border-t border-green-200 z-50">
          <div className="max-w-6xl mx-auto flex items-center justify-between gap-4 md:gap-6">
            <div className="hidden sm:block">
              <div className="text-[10px] font-bold text-green-600 uppercase tracking-widest mb-1">Session Data</div>
